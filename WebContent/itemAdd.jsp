...
<body>
	...
	<div id="main">
			...
			<s:form action="ItemAddConfirmAction">
				<input type="hidden" name="id" value="<s:property value="id" />">
					...
					<table class="box">
						...
						<tr>
							<td><span>追加個数</span></td>
							<td>
								<input type="number" name="last" value=""  style="text-align: right; "/><span>個</span>
							</td>
						</tr>
		...
		<div><p><a href='<s:url action="GoAdminAction"/>'>管理画面へ</a></p></div>
	</div>
