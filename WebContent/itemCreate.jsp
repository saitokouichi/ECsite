			...
			<table>
				<s:form action="ItemCreateConfirmAction">
					<tr>
						...
						<td>
							<input type="text" name="productName"  value=""  style="text-align: right; "/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="nedan" value=""  style="text-align: right; "/>
							<span>円</span>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="stock" value=""  style="text-align: right; "/>
							<span>個</span>
						</td>
					</tr>
