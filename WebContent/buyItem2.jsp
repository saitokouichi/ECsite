...
<body>
	...
	<div id="side01">
		<s:if test="#session.login_user_id !=null">
		<img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo">
		</s:if>
	</div>
...
<!-- 							</td> -->
						...
						<tr>
							...
							<s:else>
							<td><s:submit value="今すぐ購入" class="buy" onclick="goBuyItem2Action();"/></td>
	...
	<div id="side02">
<%-- 		<s:if test="#session.login_user_id !=null"> --%>
<!-- 		<img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br><img src="gazo.jpg" height="auto" width="100%" class="gazo"><br> -->
<%-- 		</s:if> --%>
	</div>

<footer id="footer">
	<s:form  action="AdminAction">
		<s:submit value="管理者" class="button"/>
	</s:form>
</footer>
</body>
</html>